package buzz.getcoco.example.simplechatexample.Utilities;
...
public class LoginHelper {
  ...
  public static void init(@NonNull Context c) {
    ...
    LoginHelper.baseUrl = userInfo.getString(BASE_URL_KEY, null);
    LoginHelper.username = userInfo.getString(USERNAME_KEY, null);
  }
